...
export default function MarineNewPage() {
  ...
  const fetchEntries = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/entries/marine-new/?${params}`, {
        credentials: 'include',
      });
  ...
  const handleSave = async (formData: Partial<MarineNewEntry>) => {
    ...
    const url = editingEntry
      ? `${API_BASE_URL}/api/entries/marine-new/${editingEntry.id}/`
      : `${API_BASE_URL}/api/entries/marine-new/`;
  ...
  const handleDelete = async (entry: MarineNewEntry) => {
    ...
    const response = await fetch(`${API_BASE_URL}/api/entries/marine-new/${entry.id}/`, {
      method: 'DELETE',
      credentials: 'include',
    });
